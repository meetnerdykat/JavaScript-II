...
// create/initialize an empty array named fullName and set it's value equal to and empty array that will hold the new array I need to create
let fullName = [];

// iterate through the runners array using the .forEach array method
runners.forEach(runner => {
  // take the fullName variable that's an empty array and place all the first and last names in it using the .push() method
  fullName.push(runner.first_name + ' ' + runner.last_name);
});

// log to the console what the fullName array now is (after I've mutated it by applying the steps above)
console.log(fullName);

// ==== Challenge 2: Use .map() ====
// The event director needs to have all the runner's first names converted to uppercase because the director BECAME DRUNK WITH POWER. Convert each first name into all caps and log the result

// create/initialize an empty array named allCaps. It will hold the new array I need to create
let allCaps = [];

// USE/ASSIGN the allCaps array and make it hold a value of the mapped runners array... the .map method returns a new array of whatever I request it to ...
allCaps = runners.map(runner => {
  return runner.first_name.toUpperCase();
});

// log to the console what the allCaps array now is (after I've mutated it by applying the steps above)
console.log(allCaps);
